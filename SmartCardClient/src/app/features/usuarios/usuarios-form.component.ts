      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a routerLink="/usuarios" class="btn btn-link d-flex align-items-center">
            ...
            @if (!(loading$ | async)) {
              <form [formGroup]="form" (ngSubmit)="onSubmit()">
                <div class="form-group mb-3">
                  ...
                  <input id="titulo" formControlName="titulo" type="text" class="form-control" placeholder="Ej: Sr., Sra., Dr.">
                </div>
                ...
                <div class="form-group mb-3">
                  <label for="infoExtra" class="form-label">Información Extra</label>
                  <textarea id="infoExtra" formControlName="infoExtra" rows="3" class="form-control" placeholder="Notas adicionales..."></textarea>
                </div>
