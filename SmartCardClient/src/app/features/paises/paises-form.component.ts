      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5>{{ isEdit ? 'Editar País' : 'Nuevo País' }}</h5>
            <a routerLink="/paises" class="btn btn-link d-flex align-items-center">
          ...
          <div class="card-body">
            ...
            @if (!(loading$ | async)) {
              <form [formGroup]="form" (ngSubmit)="onSubmit()">
                ...
                <div class="form-group mb-3">
                  <label for="codigoIso2" class="form-label">Código ISO 2</label>
                  <input id="codigoIso2" formControlName="codigoIso2" type="text" maxlength="2" class="form-control text-uppercase" placeholder="CO">
                </div>
                ...
                <div class="d-flex gap-2 mt-4">
                  ...
                  <a routerLink="/paises" class="btn btn-secondary">Cancelar</a>
                </div>
              </form>
            }
          </div>
...
export class PaisesFormComponent implements OnInit {
  ...
  private readonly service = inject(PaisesService);
