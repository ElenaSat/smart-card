      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5>{{ isEdit ? 'Editar Formato' : 'Nuevo Formato' }}</h5>
            <a routerLink="/formato-tarjetas" class="btn btn-link d-flex align-items-center">
            ...
            @if (!(loading$ | async)) {
              <form [formGroup]="form" (ngSubmit)="onSubmit()">
                ...
                <div class="d-flex gap-2 mt-4">
                  ...
                  <a routerLink="/formato-tarjetas" class="btn btn-secondary">Cancelar</a>
                </div>
              </form>
            }
          </div>
...
export class FormatoTarjetasFormComponent implements OnInit {
  ...
  private readonly service = inject(FormatoTarjetasService);
